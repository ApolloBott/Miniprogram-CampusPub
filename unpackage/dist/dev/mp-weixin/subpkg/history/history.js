...
var _history = _interopRequireDefault(__webpack_require__(/*! ./subpkg/history/history.vue */ 95));
// @ts-ignore
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _history_vue_vue_type_template_id_541b7da4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./history.vue?vue&type=template&id=541b7da4& */ 96);
/* harmony import */ var _history_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./history.vue?vue&type=script&lang=js& */ 98);
...
/* harmony import */ var _history_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./history.vue?vue&type=style&index=0&lang=scss& */ 100);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                // 我收藏的
                _this2.loadTabData(2) // 我留言的
                ]);
              case 4:
                console.log('[History] 所有数据加载完成');
                console.log('  - 浏览:', _this2.viewedGoodsList.length);
                console.log('  - 收藏:', _this2.collectedGoodsList.length);
                console.log('  - 留言:', _this2.commentedGoodsList.length);
                _context2.next = 14;
                break;
              case 10:
                _context2.prev = 10;
                _context2.t0 = _context2["catch"](0);
                console.error('[History] 加载数据失败:', _context2.t0);
                uni.showToast({
                  title: '加载失败，请重试',
                  icon: 'none'
                });
        ...
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 19:
                ids = idsResponse.data.data || []; // 保存 ID 列表
              ...
              case 32:
                ...
                goodsList = goodsResponse.data.message || []; // 保存商品详情列表
                          ...
                          switch (_context5.prev = _context5.next) {
                            case 0:
                              ...
                              return uni.$http.post('/users/clearhistory', {
                                code: _this5.openid,
                                type: _this5.activeTab // 0=浏览, 1=收藏, 2=留言
                              });
                            case 5:
                            ...
                            case 26:
                              ...
                              console.error('[History] 清空失败:', _context5.t1);
                              uni.showToast({
                                title: '清空失败，请重试',
                                icon: 'none'
                              });
